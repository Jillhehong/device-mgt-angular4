...
var EditDeviceHistoryComponent = (function () {
    ...
    EditDeviceHistoryComponent.prototype.ngOnInit = function () {
        ...
        // get device owner
        this.deviceService.getData('/deviceHistory/get/deviceOwner').subscribe(function (res) {
    ...
    EditDeviceHistoryComponent.prototype.update = function (value) {
        ...
        if (!pattern.test(value.history_date)) {
            ...
            this.deviceService.postData('/deviceHistory/update', value).subscribe(function (res) {
...
var InsertDeviceHistoryComponent = (function () {
    ...
    InsertDeviceHistoryComponent.prototype.add = function (value) {
        ...
        if (!pattern.test(value.history_date)) {
            ...
            // post data
            this.deviceService.postData('/deviceHistory/insert', value).subscribe(function (res) {
                _this.activeModal.close();
            }, function (err) {
                _this.error = err;
            });
...
var CustomerManagementComponent = (function () {
    ...
    CustomerManagementComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.deviceService.getData('/customerMgt/get').subscribe(function (res) {
...
var DashboardComponent = (function () {
    ...
    DashboardComponent.prototype.ngOnInit = function () {
        ...
        this.deviceService.getData('/dashboard/billable').subscribe(function (res) {
            res.forEach(function (value) {
        ...
        // get status
        this.deviceService.getData('/dashboard/status').subscribe(function (res) {
            res.forEach(function (value) {
        ...
        // get location
        this.deviceService.getData('/dashboard/location').subscribe(function (res) {
        ...
        // get purchase order
        this.deviceService.getData('/dashboard/purchaseOrder').subscribe(function (res) {
            // populate data for bar chart
        ...
        this.deviceService.getData('/dashboard/orderSummary').subscribe(function (res) {
...
var DeviceHistoryComponent = (function () {
    ...
    DeviceHistoryComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.deviceService.getData('/deviceHistory/get').subscribe(function (res) {
...
var DeviceManagementComponent = (function () {
    ...
    DeviceManagementComponent.prototype.filter = function (value, pop) {
        ...
        if (this.search.device_sn || this.search.parent_clinic || this.search.status || this.search.location) {
            this.deviceService.postData('/deviceMgt/filter', value).subscribe(function (res) {
    ...
    DeviceManagementComponent.prototype.clearFilter = function () {
        ...
        this.deviceService.getData('/deviceMgt/get').subscribe(function (res) {
            _this.deviceMgtData = res;
        }, function (err) { return console.log(err); });
    };
    // sort table
    ...
    LoginComponent.prototype.submit = function (user) {
        ...
        if (!user.username || !user.password) {
            ...
            this.deviceService.postData('/authenticateUser', user).subscribe(function (res) {
                ...
                _this.stateService.go('public.dashboard'); // navigate url to dashboard page after successfully logged in
            }, function (err) {
...
module.exports = "<p>\n  accessory-inventory page is on developing!\n</p>\n"
...
module.exports = "<section>\n  <h4>Hello</h4>\n    <p>\n      Welcome to my website. I spent several months on learning Angular, HTML,CSS and Node skills from Coursera.org, IT blog, forums such as Stack Overflow.\n      After some month's study, I found much passion in developing website in the front end. The Angular2 is powerful language tool that developing\n      much fun and easier. I came to the thought that I am ready to building up a website by applying the learning into practice.\n      Since I am working as a data analyst on managing medical device data daily, I decided to develop a web tool that can provide an\n      user interface for users like me can customize managing data as Excel does.\n      The motivation and interests drive me up and finally the website is completed in its first level stage. Although it still has many places to imporve,\n      to add new features (I know it takes time), I decided to deploy it on Heroku cloud server platform and put it alive for viewers.\n    </p>\n    <p>\n      The navigation bar on top provides some links to apparently. It is divided on the various data on different subjects. For example,\n      device data is separated from accessory ones, device history data is separated from accessory ones.\n      Customer data is managed separately, too. Besides of them, the dashboard gives user clearly summarized data to look at.\n      The charts to depict some characteristics of devices. All dummy data are stored in Heroku PostgreSQL database.\n    </p>\n    <p>\n      Thank you for visiting my website. If you have any interests of my work, please email me at jillhehong@gmail.com or\n      call me on 201-707-2120 for further discussion.\n    </p>\n  <br><br><br>\n</section>\n"
